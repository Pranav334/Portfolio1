      ...
      <div className="max-w-screen-lg mx-auto p-4 flex flex-col justify-center w-full h-full">
        ...
        <div className="flex flex-col md:flex-row gap-8">
          ...
          >
            ...
            >
              ...
              <div className="space-y-4 relative z-10">
                {[
                  { icon: <FaUser />, text: "Pranav Prakash", id: "name" },
                  { icon: <FaEnvelope />, text: "pranavprakash6983@gmail.com", id: "email", href: "mailto:pranavprakash6983@gmail.com" },
                  { icon: <FaPhone />, text: "+91 9153829920", id: "phone", href: "tel:+919153829920" },
                  { icon: <FaMapMarkerAlt />, text: "Jalandhar, Punjab, 144402", id: "address" }
                ].map((item, index) => (
                  <motion.div
                    key={item.id}
              ...
              >
                ...
                <div className="flex gap-4">
                  <motion.a
                    href="https://linkedin.com/in/pranavprakash56"
                    target="_blank"
                    rel="noreferrer"
                  ...
                  <motion.a
                    href="https://github.com/pranav521"
                    target="_blank"
                    rel="noreferrer"
          ...
          >
            ...
            {/* You can leave the form section as-is unless you want to personalize the submit logic or styling. */}
            <motion.form 
